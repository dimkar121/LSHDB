...
class TableApp extends JFrame {
    ...
    String queryFileName = "c://voters//eap/2010.csv";
    String qYear = "2010";
    String server = "localhost";    
    //String server = "83.212.115.69";
    int port = 4443;
    boolean performComparisons = true;
    String dbName = "eap_2009";
    ...
    public TableApp(String[] labels, String[] fieldNames, char[] mnemonics, int[] widths, String[] descriptions) {
    ...
    public static void main(String args[]) {
        ...
        String[] fieldNames = {"First Name", "Last Name", "Address", "Town","Year"};
        char[] mnemonics = {'F', 'L', 'A', 'T'};
        int[] widths = {25, 25, 25, 25};
        String[] descriptions = {"First Name", "Last Name", "Address", "Town","Year"};
        TableApp main = new TableApp(labels, fieldNames, mnemonics, widths, descriptions);
