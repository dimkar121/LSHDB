...
class IndexFormApp extends JFrame {
    ...
    public IndexFormApp(String[] labels, String[] fieldNames, char[] mnemonics, int[] widths, String[] descriptions) {
        ...
        dbNames = (Vector<String>) client.submitCommand(Server_Thread.GET_KEYED_STORES);
        ...
        dbButt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {              
                ...
                final String[] indexFieldNames = (String[]) client.submitCommand(Server_Thread.GET_KEYED_FIELDS + dbName);
    ...
    public static void main(String args[]) {
        ...
        String[] descriptions = {};
        IndexFormApp main = new IndexFormApp(labels, fieldNames, mnemonics, widths, descriptions);
