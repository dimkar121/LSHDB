...
public class Server {
    ...
    public Server(String configDir) {
        ...
        //String[] remoteAliases = config.get(0, "remote_nodes", "remote_node", "alias");
        String[] remoteAliases = config.get(0, "remote_nodes",  "alias");
        
        //String[] remoteNodeUrls = config.get(0, "remote_nodes", "remote_node", "url");            
        //String[] ports = config.get(0, "remote_nodes", "remote_node", "port");
        //String[] enableds = config.get(0, "remote_nodes", "remote_node", "enabled");
        ...
        for (int i=0; i<remoteAliases.length ; i++){
            ...
            //System.out.println("reading "+remoteAliases[i]+" "+remoteNodeUrls[i]);
        }   
        ...
        for (int i = 0; i < dbNames.length; i++) {
            ...
            //for (int k=0; k < remoteStores.length ; k++){
              //  System.out.println(dbNames[i]+"  reading "+remoteStores[k]);
            //}
